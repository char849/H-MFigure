  ...
  <div style="overflow-x: hidden">
    <header class="position-relative mix-vh-100" data-aos="fade-left">
      ...
      >
        ...
        <span class="downFill border rounded-pill pt-6 px-3 pb-3">
          <img src="/img/down-long.svg" class="zIndex" alt="Scroll Down" />
        </span>
      </button>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-xl-5 col-lg-5" data-aos="fade-left">
            ...
            <hr class="line" />
            <div
              class="d-xl-flex d-lg-flex d-md-flex mt-4 mx-2 mx-xl-0 mx-lg-0"
            >
              <div class="me-2 mt-1">
                <img
    ...
    <section class="position-relative box-bg05">
      <div class="container">
        <div class="row justify-content-center m-0">
          ...
          >
            <div
              class="rounded-5 bg-white shadow mx-3 px-4 py-6 me-xl-3 me-lg-3"
            >
              <div class="me-2 mt-1">
            ...
            <div
              class="rounded-5 bg-white shadow mx-3 px-4 py-6 mt-4
               mb-4 mb-xl-0 mb-lg-0 mt-xl-0 mt-lg-0"
            >
              <div class="me-2 mt-1">
                <img
                  src="/img/screen-users.svg"
                  width="28"
                  alt="Screen Users"
                />
              </div>
    ...
    <section>
                  ...
                  <div class="card02 rounded-5 shadow bg-white h-100">
                    ...
                    <div class="card-body position-relative">
                      ...
                      <div class="pb-7 pb-md-5 pb-lg-5 pb-xl-5 pt-2 d-flex">
                        <span
                          class="fs-6 fs-lg-5 fs-xl-5 fs-md-5 text-secondary"
                          ><img
      ...
      <div class="col-12 d-flex position-relative">
        ...
        <div class="position-absolute infoBtn top-0">
          <RouterLink
            to="/information"
            type="button"
            class="btn btn-warning rounded-pill my-2 my-lg-5 my-md-4 my-xl-5 py-3 px-8 text-dark"
          >
            更多展覽資訊
          </RouterLink>
        </div>
